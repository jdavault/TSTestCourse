...
var mockGetAllElements = jest.fn();
...
describe('ReservationsDataAccess test suite', function () {
    var sut;
    var someId = '1234';
    var someReservation = {
        endDate: 'someEndDate',
    ...
    beforeEach(function () {
        sut = new ReservationsDataAccess_1.ReservationsDataAccess();
    ...
    it('should return the id of newly created reservation', function () { return __awaiter(void 0, void 0, void 0, function () {
        var actual;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockInsert.mockResolvedValueOnce(someId);
                    return [4 /*yield*/, sut.createReservation(someReservation)];
                case 1:
                    actual = _a.sent();
    ...
    it('should make the update reservation call', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sut.updateReservation(someId, 'endDate', 'someOtherEndDate')];
                case 1:
                    _a.sent();
    ...
    it('should make the delete reservation call', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sut.deleteReservation(someId)];
                case 1:
                    _a.sent();
    ...
    it('should return reservation by id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var actual;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    mockGetBy.mockResolvedValueOnce(someReservation);
                    return [4 /*yield*/, sut.getReservation(someId)];
                case 1:
                    actual = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sut.getAllReservations()];
                case 1:
                    actual = _a.sent();
