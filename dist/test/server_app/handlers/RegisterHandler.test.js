...
describe('RegisterHandler test suite', function () {
    ...
    var someId = '1234';
    beforeEach(function () {
        sut = new RegisterHandler_1.RegisterHandler(request, responseMock, authorizerMock);
    });
    afterEach(function () {
        jest.clearAllMocks();
    });
    it('should register valid accounts in requests', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(responseMock.writeHead).toBeCalledWith(ServerModel_1.HTTP_CODES.BAD_REQUEST, { 'Content-Type': 'application/json' });
